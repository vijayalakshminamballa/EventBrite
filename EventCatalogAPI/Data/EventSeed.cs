...
Date=new DateTime(12/24/2019),Price=30,Organizer="WestFieldSouthern Center",AddressLine= "Cross Roads Mall",City="Bellevue" ,State="WA",PictureUrl = "http://externalcatalogtobereplaced/api/pic/1" },
...
Date=new DateTime(12/12/2019),Price=50,Organizer="Palesade Restaurent", AddressLine="Overlake Plaza",City= "Seattle",State="WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/2"},
...
Date=new DateTime(10/12/2019),Price=100.5M,Organizer="Washington Wine cruise",AddressLine="South Lake Union",City="Seattle",State="WA",PictureUrl="http://externalcatalogbaseurltobereplaced/api/pic/3"},
...
Date=new DateTime(09/30/2019),Price=60.8M,Organizer="Altoros", AddressLine="Tamber Creek Estates",City="Bothell",State="WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/4"},
...
Date=new DateTime(10/25/2019),Price=54,Organizer="Entirely Technology",AddressLine="Bellevue Collge",City="Bellevue",State="WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/5"},
...
Date=new DateTime(12/16/2019),Price=45,Organizer="TrueVs",AddressLine="Safeco Plaza",City="Seattle",State="WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/6"},
...
Date=new DateTime(11/18/2019),Price=23,Organizer="Mind the Product",AddressLine="Seattle Learning Center",City="Seattle",State="WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/7"},
...
Date=new DateTime(10/25/2019),Price=90,Organizer="Local SEO Search",AddressLine="Charlotte",City="Charlotte",State="NC",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/8" },

                new Event() { EventTypeId= 4,EventCategoryId=5,Description ="The Faim & Stand Atlantic @ The Vera Project ",Name = "Music Performance ",
Date=new DateTime(12/20/2019),Price=200,Organizer="The Crocodile",AddressLine="The Lakes",City="Renton",State="WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/9" },
...
Date=new DateTime(12/26/2019),Price=10,Organizer="Kailasa of Seattle",AddressLine="LV Temple" ,City="Bellevue",State="WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/10" },

                new Event() { EventTypeId= 2,EventCategoryId=4,Description ="Free Soccer Classes for 2-3 Year Olds ",Name = " Soccer Classes",
Date=new DateTime(11/23/2019),Price=32,Organizer="Scoccer ShotS Seattle",AddressLine="GreenLake Playgroud",City="Seattle",State="WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/11" },
...
Date=new DateTime(11/29/2019),Price=73,Organizer="Bolly Works",AddressLine="Trails of Redmond",City="Redmond",State="WA", PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/12" },

                new Event() { EventTypeId= 2,EventCategoryId=4,Description ="FREE Yoga with a View at Hotel Sorrento ",Name = "Yoga Classes ",
Date=new DateTime(10/30/2019),Price=25,Organizer="Hotel Sorrento",AddressLine="Hotel Sorrento" ,City="Seattle",State="WA", PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/13" },
...
Date=new DateTime(12/31/2019),Price=70,Organizer="ChainSmokers",AddressLine="Tacoma Dome" ,City="Tacoma",State="WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/14" },
...
Date=new DateTime(12/01/2019),Price=59,Organizer="Winery Alliance", AddressLine="Five Bainbridge Island wineries" ,City="Bainbridge",State="WA", PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/15" }
