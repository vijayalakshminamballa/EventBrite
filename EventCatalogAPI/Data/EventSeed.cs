...
Date=DateTime.Parse("10/12/2019"),Price=100.5M,Organizer="Washington Wine cruise",AddressLine="South Lake Union",City="Seattle",State="WA",PictureUrl="http://externalcatalogbaseurltobereplaced/api/pic/3", EventCapacity = 23},
...
Date=DateTime.Parse("09/30/2019"),Price=60.8M,Organizer="Altoros", AddressLine="Tamber Creek Estates",City="Bothell",State="WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/4",EventCapacity = 27},
...
Date=DateTime.Parse("10/25/2019"),Price=54,Organizer="Entirely Technology",AddressLine="Bellevue Collge",City="Bellevue",State="WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/5",EventCapacity = 25},
...
Date=DateTime.Parse("12/20/2019"),Price=200,Organizer="The Crocodile",AddressLine="The Lakes",City="Renton",State="WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/9",EventCapacity = 43 },
...
Date=DateTime.Parse("12/26/2019"),Price=10,Organizer="Kailasa of Seattle",AddressLine="LV Temple" ,City="Bellevue",State="WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/10",EventCapacity = 23 },

                new EventItem() { EventTypeId= 2,EventCategoryId=4,Description ="Free Soccer Classes for 2-3 Year Olds ",Name = " Soccer Classes",
Date=DateTime.Parse("11/23/2019"),Price=32,Organizer="Scoccer ShotS Seattle",AddressLine="GreenLake Playgroud",City="Seattle",State="WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/11",EventCapacity=25 },
...
Date=DateTime.Parse("11/29/2019"),Price=73,Organizer="Bolly Works",AddressLine="Trails of Redmond",City="Redmond",State="WA", PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/12",EventCapacity=27 },

                new EventItem() { EventTypeId= 2,EventCategoryId=4,Description ="FREE Yoga with a View at Hotel Sorrento ",Name = "Yoga Classes ",
Date=DateTime.Parse("10/30/2019"),Price=25,Organizer="Hotel Sorrento",AddressLine="Hotel Sorrento" ,City="Seattle",State="WA", PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/13",EventCapacity=30 },
...
Date=DateTime.Parse("12/31/2019"),Price=70,Organizer="ChainSmokers",AddressLine="Tacoma Dome" ,City="Tacoma",State="WA",PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/14",EventCapacity=32 },
...
Date=DateTime.Parse("12/01/2019"),Price=59,Organizer="Winery Alliance", AddressLine="Five Bainbridge Island wineries" ,City="Bainbridge",State="WA", PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/15",EventCapacity=23}
