...
using Order = WebMVC.Models.BookingModels.Order;
...
namespace WebMvc.Controllers
{
    ...
    public class BookingController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    if (stripeCharge.Id != null)
                    {
                        ...
                        int orderId = await _bookingSvc.CreateOrder(order);
        ...
        public async Task<IActionResult> Detail(string orderId)
        {
            ...
            var order = await _bookingSvc.GetOrder(orderId);
            return View(order);
        }

        public async Task<IActionResult> Index()
        {
            var vm = await _bookingSvc.GetOrders();
            return View(vm);
        }
